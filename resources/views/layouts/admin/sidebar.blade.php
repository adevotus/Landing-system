<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <a href="{{ route('gsa_staffs') }}" class="nav-link"> <i class="far fa-user"></i> <span>Staff</span></a>

            </li>
            <li><a class="nav-link" href="{{route('blog')}}"><i class="fas fa-exclamation"></i> <span>Blogs</span></a></li>
            <li class="dropdown">
                <a href="{{ route('publications') }}" class="nav-link"><i
                        class="fas fa-columns"></i><span>Publications</span></a>
