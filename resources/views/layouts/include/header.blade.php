<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
    <div class="container"><a class="navbar-brand" href="/"><img class="d-inline-block" src="{{asset('landing/assets/img/logo_new.png')}}" width="40" alt="logo" /><span class="fw-bold text-primary ms-2"></span></a>
      ...
      <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto pt-2 pt-lg-0 font-base">
          ...
          <li class="nav-item px-2"><a class="nav-link" href="#booksCover"> <span class="nav-link-icon text-800 me-1 fas fa-book"></span><span class="nav-link-text">Our Product</span></a></li>
